...
<div class = "schedule-form"> 
	<a href="SellerPage.jsp"> <button class="back"> Back </button></a>
	<form action="" method = "POST">
	    ...
	    <select class="product-dropdown"  name="products" required>
	      ...
	      <input class="bid-value" type="text" placeholder="Enter Minimum Bid Value">
	       <input class="start-date" type="date" name="StartDate">
	        <input type="date" class="end-date" name="EndDate">
		<input type="submit" class="submit" name="submit" value="Schedule">
	</form> 
</div>
